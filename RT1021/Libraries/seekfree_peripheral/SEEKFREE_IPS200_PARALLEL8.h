...
#define IPS200_DATA_PORT        2       //1：B端口  2：C端口  3：D端口
    ...
    #define IPS200_DATAPORT     PORTB_DR	    //宏定义GPIO的输出寄存器
#elif( 2 == IPS200_DATA_PORT )
    #define IPS200_DATAPORT     PORTC_DR	    //宏定义GPIO的输出寄存器
#elif( 3 == IPS200_DATA_PORT )
    #define IPS200_DATAPORT     PORTD_DR	    //宏定义GPIO的输出寄存器
#endif
